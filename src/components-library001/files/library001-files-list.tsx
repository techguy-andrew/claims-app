...
interface Library001FilesListProps {
  files: Library001ClaimFile[]
  onFileAction?: (action: 'view' | 'download' | 'tag' | 'delete', file: Library001ClaimFile) => void
  loading?: string | null
...
export function Library001FilesList({ 
  files, 
  onFileAction, 
  loading = null, 
  ...
  const createFileMenuActions = (file: Library001ClaimFile): Library001MenuAction[] => [
    {
      id: 'view',
      label: 'View',
  ...
  const handleViewFile = (file: Library001ClaimFile) => {
...
export default Library001FilesList